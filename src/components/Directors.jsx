    ...
    <section className="py-[50px] xl:py-[100px] bg-[#1173b942]">
      <div className="container mx-auto px-4">
        <div className="flex justify-center mb-[60px] md:mb-[50px] lg:mb-[80px]">
          <h2 className="text-[24px] sm:text-[30px] md:text-[38px] font-bold uppercase tracking-wider text-center">
            Meet Our Directors
          </h2>
        </div>
        <div className="flex justify-center items-center gap-[50px] sm:gap-[70px] md:gap-[50px] lg:gap-[70px] xl:gap-[100px] flex-wrap">
