  ...
  return (
    <>
      <section className='border-b-[1px] border-dotted border-[#0000005c] '>
        <div className="row">
          <ul className='flex overflow-hidden py-[40px] bg-white relative before:absolute before:top-0 before:w-[250px] before:h-[100%] before:z-[2] before:left-0 before:bg-custom-gradient border-b-[1px] border-dotted border-[#0000005c]'>
          ...
          <ul className='flex overflow-hidden py-[40px] bg-white relative after:absolute after:top-0 after:w-[250px] after:h-[100%] after:z-[2] after:right-0 after:bg-custom-gradient2'>
