                        ...
                        <div className="w-full ">
                            <div className="flex justify-center pb-[50px]">
                                <div className="w-full 2xl:w-8/12 text-center">
                                    <h5 className='text-[24px] sm:text-[30px] md:text-[40px] lg:text-[44px] font-Secondary font-medium capitalize'>About The Hidden ideas</h5>
